export const BIP39_WORDLIST: string[] = [
  ...
  'choice', 'choose', 'chronic', 'chuckle', 'chunk', 'churn', 'cigar', 'circle',
  ...
  'first', 'fish', 'fit', 'fitness', 'fix', 'flag', 'flame', 'flash',
  ...
  'high', 'hill', 'hint', 'hip', 'hire', 'history', 'hobby', 'hold',
  ...
  'inform', 'initial', 'initiate', 'inject', 'inmate', 'inner', 'innocent', 'input',
  ...
  'learn', 'leave', 'lecture', 'left', 'leg', 'legal', 'legend', 'lemon',
  ...
  'monitor', 'monkey', 'month', 'moon', 'moral', 'more', 'morning', 'mosquito',
  ...
  'riot', 'ripple', 'risk', 'river', 'road', 'roast', 'robot', 'robust',
  ...
  'story', 'stove', 'strategy', 'street', 'strike', 'strong', 'structure', 'struggle',
  ...
  'surround', 'survey', 'survive', 'suspect', 'sustain', 'swallow', 'swamp', 'swap',
  ...
  'vast', 'vault', 'vehicle', 'velvet', 'vendor', 'venture', 'verb', 'verify',
  ...
  'volume', 'vote', 'voyage', 'wage', 'wait', 'walk', 'wall', 'walnut',
...
export function getWord(index: number): string {
  const safeIndex = ((index % BIP39_WORDLIST.length) + BIP39_WORDLIST.length) % BIP39_WORDLIST.length;
  return BIP39_WORDLIST[safeIndex];
}
