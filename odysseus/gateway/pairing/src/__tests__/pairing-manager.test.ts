...
import { createDeviceIdentityManager } from '@odysseus/identity';
import type { DeviceCertificate } from '@odysseus/protocol';
...
describe('PairingManager', () => {
  ...
  beforeEach(async () => {
    tmpDir = mkdtempSync(path.join(tmpdir(), 'odysseus-pairing-test-'));
