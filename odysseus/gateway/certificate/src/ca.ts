...
export const DEFAULT_ROOT_CA_CONFIG: CAConfig = {
  organizationName: 'Odysseus',
  commonName: 'Odysseus Root CA',
  countryName: 'US',
...
export const DEFAULT_INTERMEDIATE_CA_CONFIG: CAConfig = {
  organizationName: 'Odysseus',
  commonName: 'Odysseus Intermediate Device CA',
  countryName: 'US',
  organizationalUnitName: 'Security',
...
export class CertificateAuthority {
  ...
  verifyDeviceCertificate(certPem: string): {
    ...
    try {
      ...
      // "CN=Odysseus Root CA" as its issuer and be trusted as a paired device.
